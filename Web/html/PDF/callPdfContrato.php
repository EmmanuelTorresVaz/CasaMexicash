...
if (!isset($_GET['pdf'])) {
    ...
    <form>
           ...
           <tbody>
                <tr>
                    <td colspan="12" align="right">
                        <h3>Contrato No. ' . $idContrato . '</h3>
                    </td>
                </tr>
                <tr>
                    <td colspan="12">
                        <p><h6>
                            Fecha de celebración del contrato: CIUDAD DE MEXICO NA a ' . $FechaCreacion . '</label>
        ...
        <tr>
            ...
            <td colspan="2">' . $MontoPrestamo . '</label>
                Moneda Nacional
            </td>
            <td colspan="2">' . $MontoTotal . '</label>
        ...
        <tr>
            <td colspan="12">
                PLAZO DEL PRESTAMO (Fecha limite para el refrendo o desempeño):' . $FechaAlmoneda . ' </label>.
                Total de
    ...
    $contenido .= '<a href="callPdfContrato.php?pdf=1">Generar Pdf</a>';
